...
for cuts in [allcuts,displacedcuts]:
#for events in [displacedevents]:
    ...
    events.Draw("{0}:{1}>>h(100,300,800,100,300,800)".format(z_yzplane[2],z_yzplane[1]),"","colz")
    gDirectory.Get("h").SetTitle("Z from Y={0} intercept;positive track;negative track".format(yoffset))
    c.Print(outfilename+".pdf");

    events.Draw("pz2:pz1>>h(100,0,100,100,0,100)","","colz")
    gDirectory.Get("h").SetTitle("pz;positive track;negative track")
    c.Print(outfilename+".pdf");
    
    #events.Draw("ty2:ty1>>h(100,-0.1,0.1,100,-0.1,0.1)","","colz")
    #gDirectory.Get("h").SetTitle("ty;positive track;negative track")
    #c.Print(outfilename+".pdf");
    
    #events.Draw("tx2_st1:tx1_st1>>h(100,-0.2,0.2,100,-0.2,0.2)","","colz")
    #gDirectory.Get("h").SetTitle("tx_st1 (before KMAG);positive track;negative track")
    #c.Print(outfilename+".pdf");
    
    #events.Draw("tx2:tx1>>h(100,-0.2,0.2,100,-0.2,0.2)","","colz")
    #gDirectory.Get("h").SetTitle("tx (after KMAG);positive track;negative track")
    #c.Print(outfilename+".pdf");
    
    #events.Draw("{0}:tx1_st1>>h(100,-0.2,0.2,100,-100,100)".format(x_st1[1]),"","colz")
    #gDirectory.Get("h").SetTitle("positive track;tx_st1;extrapolated X at St1")
    #c.Print(outfilename+".pdf");
    
    #events.Draw("{0}:tx2_st1>>h(100,-0.2,0.2,100,-100,100)".format(x_st1[2]),"","colz")
    #gDirectory.Get("h").SetTitle("negative track;tx_st1;extrapolated X at St1")
    #c.Print(outfilename+".pdf");
    
    events.Draw("triggerBits>>h(10,-0.5,9.5)","","colz")
    gDirectory.Get("h").SetTitle("triggerBits")
    c.Print(outfilename+".pdf");
    
    events.Draw("nTracks>>h(10,-0.5,9.5)","","colz")
    gDirectory.Get("h").SetTitle("nTracks")
    c.Print(outfilename+".pdf");
    
    events.Draw("spillID>>h(100,1407e3,1417e3)","","colz")
    gDirectory.Get("h").SetTitle("spillID")
    c.Print(outfilename+".pdf");
    
    events.Draw("chisq2:chisq1>>h(100,0,50,100,0,50)","","colz")
    gDirectory.Get("h").SetTitle("chisq;positive track;negative track")
    c.Print(outfilename+".pdf");
    
    #events.Draw("chisq1:nHits1>>h(10,10.5,20.5,100,0,50)","","colz")
    #gDirectory.Get("h").SetTitle("positive track;nHits;chisq")
    #c.Print(outfilename+".pdf");
    
    #events.Draw("chisq2:nHits2>>h(10,10.5,20.5,100,0,50)","","colz")
    #gDirectory.Get("h").SetTitle("negative track;nHits;chisq")
    #c.Print(outfilename+".pdf");
    
    events.Draw("nHits2:nHits1>>h(10,10.5,20.5,10,10.5,20.5)","","colz")
    gDirectory.Get("h").SetTitle("nHits;positive track;negative track")
    c.Print(outfilename+".pdf");
    
    c.SetLogz(1)
    events.Draw("pz1:nHits1>>h(10,10.5,20.5,25,0,50)","","colz")
    gDirectory.Get("h").SetTitle("positive track;nHits;pz")
    c.Print(outfilename+".pdf");
    
    events.Draw("pz2:nHits2>>h(10,10.5,20.5,25,0,50)","","colz")
    gDirectory.Get("h").SetTitle("negative track;nHits;pz")
    c.Print(outfilename+".pdf");
    c.SetLogz(0)
    
    events.Draw("nHits2_st1:nHits1_st1>>h(10,0.5,10.5,10,0.5,10.5)","","colz")
    gDirectory.Get("h").SetTitle("nHits;positive track;negative track")
    c.Print(outfilename+".pdf");
    
    events.Draw("pz1:nHits1_st1>>h(10,0.5,10.5,25,0,50)","","colz")
    gDirectory.Get("h").SetTitle("positive track;nHits;pz")
    c.Print(outfilename+".pdf");
    
    events.Draw("pz2:nHits2_st1>>h(10,0.5,10.5,25,0,50)","","colz")
    gDirectory.Get("h").SetTitle("negative track;nHits;pz")
    c.Print(outfilename+".pdf");
    
    events.Draw("pz1:st1Hits1>>h(50,20.5,70.5,25,0,50)","","colz")
    gDirectory.Get("h").SetTitle("positive track;nHits;pz")
    c.Print(outfilename+".pdf");
    
    events.Draw("pz2:st1Hits2>>h(50,20.5,70.5,25,0,50)","","colz")
    gDirectory.Get("h").SetTitle("negative track;nHits;pz")
    c.Print(outfilename+".pdf");
    
    events.Draw("{0}:{1}>>h(4,-0.5,3.5,4,-0.5,3.5)".format(quad_st1[2],quad_st1[1]),"","colz")
    gDirectory.Get("h").SetTitle("quadrants;positive track;negative track")
    c.Print(outfilename+".pdf");
    
    events.Draw("{0}:{1}>>h(100,-150,150,100,-50,50)".format(y_st1[1],x_st1[1]),"","colz")
    gDirectory.Get("h").SetTitle("positive track extrapolated to St1;X [cm];Y [cm]")
    c.Print(outfilename+".pdf");

    events.Draw("{0}:{1}>>h(100,-150,150,100,-50,50)".format(y_st1[2],x_st1[2]),"","colz")
    gDirectory.Get("h").SetTitle("negative track extrapolated to St1;X [cm];Y [cm]")
    c.Print(outfilename+".pdf");
    
    events.Draw("{0}:{1}>>h(100,-150,150,100,-150,150)".format(y_st2[1],x_st2[1]),"","colz")
    gDirectory.Get("h").SetTitle("positive track extrapolated to St2;X [cm];Y [cm]")
    c.Print(outfilename+".pdf");

    events.Draw("{0}:{1}>>h(100,-150,150,100,-150,150)".format(y_st2[2],x_st2[2]),"","colz")
    gDirectory.Get("h").SetTitle("negative track extrapolated to St2;X [cm];Y [cm]")
    c.Print(outfilename+".pdf");
    
    events.Draw("{0}:{1}>>h(100,-50,50,100,-50,50)".format(y_st1[2],y_st1[1]),"","colz")
    gDirectory.Get("h").SetTitle("extrapolated Y at St1;positive track [cm];negative track [cm]")
    c.Print(outfilename+".pdf");
    
    events.Draw("{0}:{1}>>h(100,-150,150,100,-150,150)".format(y_st2[2],y_st2[1]),"","colz")
    gDirectory.Get("h").SetTitle("extrapolated Y at St2;positive track [cm];negative track [cm]")
    c.Print(outfilename+".pdf");

    events.Draw("{0}:{1}>>h(100,-50,50,100,-50,50)".format(x_dump[2],x_dump[1]),"","colz")
    gDirectory.Get("h").SetTitle("extrapolated X at dump;positive track [cm];negative track [cm]")
    c.Print(outfilename+".pdf");

    events.Draw("{0}:{1}>>h(100,-50,50,100,-50,50)".format(y_dump[2],y_dump[1]),"","colz")
    gDirectory.Get("h").SetTitle("extrapolated Y at dump;positive track [cm];negative track [cm]")
    c.Print(outfilename+".pdf");

    events.Draw("{0}:{1}>>h(100,-50,50,100,-50,50)".format(x_500[2],x_500[1]),"","colz")
    gDirectory.Get("h").SetTitle("extrapolated X at Z=500;positive track [cm];negative track [cm]")
    c.Print(outfilename+".pdf");

    events.Draw("{0}:{1}>>h(100,-50,50,100,-50,50)".format(y_500[2],y_500[1]),"","colz")
    gDirectory.Get("h").SetTitle("extrapolated Y at Z=500;positive track [cm];negative track [cm]")
    c.Print(outfilename+".pdf");
